			 ...
			 const char *label):Fl_Gl_Window(x, y, w, h, label)
{
	...
	m_drawAxes = true;
	m_drawSkeleton = true;
	m_drawColor = false;	//EXTRA-CREDIT - Coloring of joints
}
    ...
    case FL_KEYUP:
    	{
			...
			//EXTRA-CREDIT
			//----------------------------------------------------------
			//When toggle key c and when not in drawSkeleton mode,
			//you enable coloring of the joints.
			//Color is disabled when viewing Skeleton
			//==========================================================
			else if (key == 'c' )
			{
			...
			//EXTRA-CREDIT
			//----------------------------------------------------------
			//Enable color only if toggled on and not viewing skeleton
			//==========================================================
			    if (m_drawSkeleton == 0){
				if (m_drawColor){
			    	glEnable(GL_COLOR_MATERIAL);
